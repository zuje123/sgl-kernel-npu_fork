...
{
    std::cout << "[deepep] rank:" << rank << " enter dispatch_ffn_combine..." << std::endl;
    ...
    std::cout << "[deepep] rank:" << rank  << ", hcom_ep_name " << hcom_ep_name << std::endl;
    ...
    // /*
    if (is_int8) {
        std::cout << "[deepep111] rank:" << rank << ", is_int8 " << is_int8 << ", max_output_size " << max_output_size
