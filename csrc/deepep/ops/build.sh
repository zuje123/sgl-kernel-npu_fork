...
ASCEND_TOOLKIT_ARCH_INCLUDE=/usr/local/Ascend/ascend-toolkit/latest/aarch64-linux/include/
ASCEND_HIGH_LV_API=/usr/local/Ascend/ascend-toolkit/latest/aarch64-linux/include/ascendc/highlevel_api/lib/
