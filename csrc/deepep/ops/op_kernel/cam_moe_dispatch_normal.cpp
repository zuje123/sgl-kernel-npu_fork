...
extern "C" __global__ __aicore__ void cam_moe_dispatch_normal(GM_ADDR x, GM_ADDR expertIds, GM_ADDR send_offset,
                                                              ...
                                                              GM_ADDR recv_count, GM_ADDR put_offset, GM_ADDR expandXOut,
                                                              ...
                                                              GM_ADDR tilingGM)
{
    ...
    if (TILING_KEY_IS(TILINGKEY_NO_QUANT)) {
        ...
        op.Init(x, expertIds, send_offset, send_token_idx, recv_offset, recv_count, put_offset, expandXOut, dynamicScalesOut,
