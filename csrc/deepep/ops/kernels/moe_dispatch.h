...
#define TemplateMC2TypeFunc XType, ExpandXOutType, DynamicQuant, IsSmoothScaleExist, IsShareExpertRank
    ...
    GM_ADDR expandIdxOut, GM_ADDR workspaceGM, TPipe *pipe, const MoeDispatchTilingData *tilingData)
{
    ...
    batchSize = tilingData->moeDispatchInfo.bs;
    globalBatchSize = tilingData->moeDispatchInfo.globalBs;
    h = tilingData->moeDispatchInfo.h;
    topK = tilingData->moeDispatchInfo.k;
    blockNum = tilingData->moeDispatchInfo.aivNum;
    epRankSize = tilingData->moeDispatchInfo.epWorldSize;
    epRankId = tilingData->moeDispatchInfo.epRankId;
    moeExpertNum = tilingData->moeDispatchInfo.moeExpertNum;
    ...
    winDataSizeOffset = dataState * (tilingData->moeDispatchInfo.totalWinSize / 2) +
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::QuantInit()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::ReduceMaxInplace(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::QuantProcess()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::FillTriple(
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::InputToShare()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::SetStatus()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::WaitStatus()
{
    tpipe_->Reset();
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::ShareToOutput()
{
    if (startStatusId >= moeExpertNum) {
        return;
    }
...
template <TemplateMC2TypeClass>
__aicore__ inline void MoeDispatch<TemplateMC2TypeFunc>::Process()
{
