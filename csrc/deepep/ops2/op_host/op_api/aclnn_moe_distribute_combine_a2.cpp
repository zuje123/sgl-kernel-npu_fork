...
aclnnStatus aclnnMoeDistributeCombineA2GetWorkspaceSize(const aclTensor* expandX, const aclTensor* expertIds,
                                                            ...
                                                            const aclTensor* expandScales, const aclTensor* offsetInner, 
                                                            const aclTensor* offsetOuter, const aclTensor* countOuter,
