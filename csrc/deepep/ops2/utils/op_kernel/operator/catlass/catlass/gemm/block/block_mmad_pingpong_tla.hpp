...
template <bool ENABLE_UNIT_FLAG_, class L1TileShape_, class L0TileShape_, class ElementA_, class ElementB_,
          class ElementC_, class ElementBias_, class TileCopy_, class TileMmad_>
struct BlockMmadTla<MmadAtlasA2Pingpong<ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, ElementA_, ElementB_, ElementC_,
    ...
    CATLASS_DEVICE void operator()(TensorA &tensorA, TensorB &tensorB, TensorC &tensorC, GemmCoord const &actualShape)
    {
        ...
        for (uint32_t kLoopIdx = 0; kLoopIdx < kTileCount; kLoopIdx++) {
            ...
            if (kLoopIdx < kTileCount - 1) {
                ...
                kActualNext = (kLoopIdxNext < kTileCount - 1) ? L1_TILE_K : (kBlockActual - kLoopIdxNext * L1_TILE_K);
