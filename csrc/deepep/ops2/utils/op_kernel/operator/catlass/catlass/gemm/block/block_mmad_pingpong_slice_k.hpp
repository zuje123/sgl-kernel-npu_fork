...
struct BlockMmad<MmadAtlasA2PingpongSliceK<ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, AType_, BType_, CType_,
...
public:
    ...
    CATLASS_DEVICE
    void operator()(AscendC::GlobalTensor<ElementA> const &gmWA, LayoutA const &layoutA,
