...
def test_main(
    ...
    # print(f'[test] {rank=} {num_tokens_per_rank=} \n')
    ...
    print(f'[layout] {ref_num_tokens_per_rank.shape=}, {ref_num_tokens_per_expert.shape=}, {ref_is_token_in_rank.shape=}')
    print(f'[layout] {num_tokens_per_rank.shape=}, {num_tokens_per_expert.shape=}, {is_token_in_rank.shape=}')
